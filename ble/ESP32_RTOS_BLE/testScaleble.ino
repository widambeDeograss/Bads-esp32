...
// Define the LCD pins (adjust these to match your LCD module)
...
void stateMachine(void)
{
  if (load_cell_sampling_enabled)
  {
    ...
    // Update the LCD with the weight
    updateLCD();
  }
}
...
void updateLCD()
{
  ...
  lcd.print("Weight: ");
  lcd.print(scale.get_units(), 1); // Display weight with 1 decimal place
  lcd.print(" kg");

  // You can add more LCD updates as needed for your application
}